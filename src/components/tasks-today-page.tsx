                    ...
                    {assignment.todayTask ? (
                      <div className="flex flex-wrap gap-2">
                        <a
                          ...
                          href={`https://www.google.com/maps/dir/?api=1&destination=${assignment.outlet.latitude},${assignment.outlet.longitude}`}
                          rel="noreferrer"
                          target="_blank"
                        >
                          Buka Navigasi
                        ...
                        <a
                          className="inline-flex rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition hover:border-slate-300"
                          href={`https://waze.com/ul?ll=${assignment.outlet.latitude},${assignment.outlet.longitude}&navigate=yes`}
                          rel="noreferrer"
                          target="_blank"
                        >
                          Waze
